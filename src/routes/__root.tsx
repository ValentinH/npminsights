...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: 'npminsights' },
      { name: 'description', content: 'Get insights about NPM packages and authors' },
    ],
    links: [
  ...
  return (
    <>
      <header className="container mx-auto flex flex-wrap items-center justify-between gap-4 p-2">
        <Link to="/" className="order-1 text-xl">
      ...
      <footer className="container mx-auto flex items-center justify-center p-4">
        <p className="flex items-center gap-1 text-gray-400">
          made by{' '}
          <a href="https://valentin-hervieu.fr" className="text-gray-100">
            Valentin Hervieu
          </a>
        </p>
      </footer>
